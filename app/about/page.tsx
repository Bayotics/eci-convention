        ...
        <section className="py-12 sm:py-16 md:py-20 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="bg-purple-100 p-2 sm:p-3 rounded-full flex-shrink-0">
                      <Heart className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 text-purple-600" />
                    </div>
                    <div>
                      <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-2">Our Mission</h3>
                  ...
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="bg-teal-100 p-2 sm:p-3 rounded-full flex-shrink-0">
                      <Target className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 text-teal-600" />
                    </div>
                    <div>
                      <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-2">Our Vision</h3>
                      <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                  ...
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-2">Our Values</h3>
                      <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
              ...
              <motion.div variants={fadeInUp}>
                <img
                  src="/images/about-us-page-section.jpeg?height=500&width=600"
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <motion.div
                ...
                className="bg-white p-6 sm:p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow"
              >
                <div className="bg-yellow-100 p-3 sm:p-4 rounded-full w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 flex items-center justify-center mb-4 sm:mb-6">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <motion.div variants={fadeInUp} className="text-center">
                <div className="bg-white/20 backdrop-blur-sm p-6 sm:p-8 rounded-lg mb-3 sm:mb-4">
                  ...
                  <p className="text-sm sm:text-base text-teal-100">23 Active Chapters</p>
                </div>
              ...
              <motion.div variants={fadeInUp} className="text-center">
                <div className="bg-white/20 backdrop-blur-sm p-6 sm:p-8 rounded-lg mb-3 sm:mb-4">
                  ...
                  <p className="text-sm sm:text-base text-teal-100">1 Active Chapter</p>
                </div>
            ...
            >
              <div className="bg-white/10 backdrop-blur-sm p-6 sm:p-8 rounded-lg">
                <h3 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 text-yellow-300">25 Chapters Globally</h3>
